window.SEI_PRODUCTS = [
  {
    ...
    "material": "Mild steel",
    "benefits": [
      "Consistent six-sided section",
      "Good machinability and weldability",
      "Suitable for repeat production"
    ],
    "url": "products/mild-steel-hexagon-bar/",
    "categoryUrl": "categories/mild-steel-bars/"
  },
  {
    "slug": "ms-square-bars",
    "name": "MS Square Bars",
    ...
    "benefits": [
      ...
      "Practical fabrication performance",
      "Custom size enquiries welcome"
    ],
    "url": "products/ms-square-bars/",
    "categoryUrl": "categories/mild-steel-bars/"
  },
  {
    ...
    "benefits": [
      ...
      "Consistent round dimensions"
    ],
    "url": "products/sae-1018-round-bright-bars/",
    "categoryUrl": "categories/bright-steel-bars/"
  },
  {
    ...
    "benefits": [
      "Strength-focused grade options",
      "Bright machining surface",
      "Made to technical enquiry"
    ],
    "url": "products/alloy-steel-bright-round-bar/",
    "categoryUrl": "categories/alloy-steel-bars/"
  },
  {
    ...
    "benefits": [
      ...
      "Versatile fabrication stock",
      "Bright and mill finish options"
    ],
    "url": "products/mild-steel-flat-bar/",
    "categoryUrl": "categories/mild-steel-bars/"
  },
  {
    "slug": "16mm-cr5-round-steel-bright-bar",
    "name": "16mnCR5 Round Steel Bright Bar",
    "category": "bright",
    "tag": "Bright Bar",
    "image": "/images/Round-Bar4.png",
    "description": "A 16mn bright round bar offering controlled dimensions and a clean surface for precision production.",
    "intro": "The 16mnCR5 round bright bar is intended for production teams that need a defined diameter and a machining-ready bright finish. Confirm the required material condition, tolerance, straightness, cut length and quantity with our team.",
    "grade": "CR5",
    "shape": "Round, 16mn",
    "finish": "Bright",
    ...
    "material": "CR5 steel",
    "benefits": [
      "Defined 16mn round section",
      "Clean bright finish",
      "Suitable for machined components"
    ],
    "url": "products/16mm-cr5-round-steel-bright-bar/",
    "categoryUrl": "categories/bright-steel-bars/"
  },
  {
    ...
    "benefits": [
      ...
      "Accurate across-flat section",
      "Efficient repeat production"
    ],
    "url": "products/en1a-bright-hex-bar/",
    "categoryUrl": "categories/bright-steel-bars/"
  },
  {
    ...
    "benefits": [
      ...
      "Multiple section possibilities"
    ],
    "url": "products/cold-drawn-bright-bar/",
    "categoryUrl": "categories/bright-steel-bars/"
  },
  {
    ...
    "benefits": [
      "Strength for industrial parts",
      "Round machining stock",
      "Grade-led manufacturing review"
    ],
    "url": "products/carbon-steel-round-bars/",
    "categoryUrl": "categories/carbon-steel-bars/"
  },
  {
    ...
    "benefits": [
      ...
      "Multiple grade possibilities",
      "Sizes made to enquiry"
    ],
    "url": "products/round-steel-bars/",
    "categoryUrl": "categories/special-steel-profiles/"
  },
  {
    ...
    "material": "Mild steel",
    "benefits": [
      "Accurate square cross-section",
      "Smooth bright faces",
      "Good machining and fabrication utility"
    ],
    "url": "products/mild-steel-square-bright-bar/",
    "categoryUrl": "categories/bright-steel-bars/"
  },
  {
    ...
    "material": "Steel to specification",
    "benefits": [
      "Purpose-made half-round profile",
      "Reduced downstream stock removal",
      "Drawing-led custom options"
    ],
    "url": "products/half-round-steel-bar/",
    "categoryUrl": "categories/special-steel-profiles/"
  }
];
